...
<html:html locale="true">
 ...
 <table width="51%" border="0" cellspacing="1" cellpadding="1" align="center">
  ...
  <tr><td><label>InsuraceType</label>&nbsp;</td>
      <td><html:select property="itype">
      <html:option value="1-year"/>
      <html:option value="2-year"/>
      <html:option value="3-year"/>
     <html:option value="4-year"/>
     <html:option value="5-year"/>
     </html:select>
      </td></tr>
