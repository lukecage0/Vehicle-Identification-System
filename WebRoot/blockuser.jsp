		...
		<TABLE BORDER="0" WIDTH="100%" HEIGHT="100%">
			...
			<TR>
				...
				<TD WIDTH="82%" HEIGHT="81%" BGCOLOR="#cccfc" NOWRAP><!--#E4ECF6-->
					<html:form action="/gotoblock">
					<html:errors/>
  <pre>                              <font size="4"><strong><center>Block User</center></strong></font></pre>
  
  
  <table width="51%" border="0" cellspacing="1" cellpadding="1" align="center">
  <tr>
    <td width="45%"><label>UserId:</label>&nbsp;</td>
    <td width="55%"><html:text property="username"/></td>
  </tr>
  
  <tr>
    <td colspan="2"  align="center"><html:submit>Submit</html:submit>
	</td>
