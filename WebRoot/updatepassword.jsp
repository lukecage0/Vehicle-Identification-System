...
<%@ page language="java" import="com.nit.vehicle.*,java.util.*"%>
...
<html:html locale="true">
 ...
 <BODY>
  ...
  <tr><td width="45%"><label> UserName</label>&nbsp;</td>
      <td width="55%"><html:text  readonly="true" property="username"/></td></tr>
  ...
  <tr><td width="45%"><label>User Type</label>&nbsp;</td>
      <td width="55%"><html:text readonly="true" property="type"/></td></tr>
      
      
  <tr><td colspan="2"  align="center"><br><center/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:submit>Update</html:submit>
	  </td>
