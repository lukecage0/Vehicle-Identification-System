		...
		<TABLE BORDER="0" WIDTH="100%" HEIGHT="100%">
			...
			<TR>
				...
				<TD WIDTH="82%" HEIGHT="81%" BGCOLOR="#cccfc" NOWRAP><!--#E4ECF6-->
					<html:form action="/changeprofile">
					<html:errors/>
  <pre><font size="4"><strong><center>Change Profile</center></strong></font></pre>
  
  
  <table width="51%" border="0" cellspacing="1" cellpadding="1" align="center">
  <tr><td width="45%"><label>Enter Userid</label>&nbsp;</td>
      <td width="55%"><html:text property="userid"/></td></tr>
