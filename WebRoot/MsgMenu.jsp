		...
		<TABLE BORDER="0" WIDTH="100%" HEIGHT="100%">
			...
			<TR>
				<TD WIDTH="25%" BGCOLOR="#CBB9F9" NOWRAP>
					<jsp:include page="menumsg.jsp"/>
				</TD>
				
				<TD WIDTH="82%" HEIGHT="81%" BGCOLOR="#cccfc" NOWRAP><!--#E4ECF6-->
					<html:form action="/gotologinpage">
					<html:errors/>
  <pre>                              <font size="4"><strong>Messages</strong></font></pre>
  
  
  <table width="51%" border="1" cellspacing="1" cellpadding="1" align="center">
  <tr>
    <input type="text" value="<%=request.getParameter("from")%>" /><br/>
  </tr>
  <tr>
    <input type="text" value="<%=request.getParameter("sub")%>" /><br/>
  </tr>
  <tr>
  <tr>
    <textarea col="40" rows="10" ><%=request.getParameter("msg")%></textarea><br/>
  </tr>
